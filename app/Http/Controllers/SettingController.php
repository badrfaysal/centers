...
class SettingController extends Controller
{
    ...
    public static function getDropdownList($key): array
    {
        ...
        $defaults = [
            'rooms' => [
                'غرفة التخاطب 1 (د. أحمد فؤاد)',
                'غرفة التخاطب 2 (د. سارة محمود)',
                'غرفة التكامل الحسي Sensory Room',
                'صالة التدريبات الحركية والبدنية',
                'غرفة اختبارات الذكاء والمقاييس',
            ],
            'session_types' => [
                'جلسة تخاطب نطق وكلام',
                'جلسة تكامل حسي (Sensory)',
                'جلسة تنمية مهارات حركية دقيقة',
                'جلسة تعديل سلوك وتوجيه نفسي',
                'جلسة مقاييس واختبارات ذكاء',
            ],
            'specializations' => [
                'أخصائي تخاطب ونطق',
                'أخصائي تنمية مهارات وتعديل سلوك',
                'أخصائي تكامل حسي (Sensory)',
                'طبيب مخ وأعصاب أطفال',
                'طبيب نفسي أطفال (Child Psychiatrist)',
                'أخصائي علاج طبيعي وحركي',
            ],
            'services' => [
                'جلسة تخاطب نطق وتخاطب شامل',
                'تنمية مهارات وتعديل سلوك',
                'تأهيل أطفال التوحد (ASD) وتأهيل نفسي',
                'علاج تشتت الانتباه وفرط الحركة (ADHD)',
                'استشارة نفسية وتوجيه أسري للأمهات',
            ],
            'expense_categories' => [
                'إيجار المركز',
